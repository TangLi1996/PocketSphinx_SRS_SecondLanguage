...
public class MainActivity_ssh extends Activity implements RecognitionListener {
...
//生成文件夹
    ...
    public  void go2nextActivity(){
        PocketSphinxUtil.get(context).stop();
        Intent intent = new Intent(MainActivity_ssh.this, MainActivity_ssh.class);
