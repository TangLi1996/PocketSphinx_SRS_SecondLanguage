...
public class MainActivity_lr extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String NowList = intent01.getStringExtra("Spinner");
        picklist = (TextView)findViewById(R.id.result);
        picklist.setText("Now pickling list is:" + NowList);
        pickedFolder = NowList;
        SpinnerPick();
        getMinimalPairs();
        context = MainActivity_lr.this;
...
//生成文件夹
    ...
    public  void go2nextActivity(){
        PocketSphinxUtil.get(context).stop();
        Intent intent = new Intent(MainActivity_lr.this, MainActivity_lr.class);
