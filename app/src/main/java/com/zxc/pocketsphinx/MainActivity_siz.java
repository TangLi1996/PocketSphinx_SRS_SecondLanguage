...
public class MainActivity_siz extends Activity implements RecognitionListener {
...
//生成文件夹
    ...
    public  void go2nextActivity(){
        PocketSphinxUtil.get(context).stop();
        Intent intent = new Intent(MainActivity_siz.this, MainActivity_siz.class);
