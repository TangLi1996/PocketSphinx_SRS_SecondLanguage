...
public class MainActivity_dji extends Activity implements RecognitionListener {
...
//生成文件夹
    ...
    public  void go2nextActivity(){
        PocketSphinxUtil.get(context).stop();
        Intent intent = new Intent(MainActivity_dji.this, MainActivity_dji.class);
