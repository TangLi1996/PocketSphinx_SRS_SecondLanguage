...
public class MainActivity_chit extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpinnerPick();
        getMinimalPairs();
        context = MainActivity_chit.this;
...
//生成文件夹
    ...
    public  void go2nextActivity(){
        PocketSphinxUtil.get(context).stop();
        Intent intent = new Intent(MainActivity_chit.this, MainActivity_chit.class);
