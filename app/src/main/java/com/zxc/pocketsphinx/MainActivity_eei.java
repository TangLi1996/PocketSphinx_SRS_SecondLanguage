...
public class MainActivity_eei extends Activity implements RecognitionListener {
...
//生成文件夹
    ...
    public  void go2nextActivity(){
        PocketSphinxUtil.get(context).stop();
        Intent intent = new Intent(MainActivity_eei.this, MainActivity_eei.class);
