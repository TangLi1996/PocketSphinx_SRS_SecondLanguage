...
public class MainActivity_mn extends Activity implements RecognitionListener {
...
//生成文件夹
    ...
    public  void go2nextActivity(){
        PocketSphinxUtil.get(context).stop();
        Intent intent = new Intent(MainActivity_mn.this, MainActivity_mn.class);
